...
devtools::load_all(here::here('../EBASE'))
...
The SA component has the largest amplitude and a frequency of once per year, with peaks in the summer and troughs in the winter. This regular periodicity may be influencing the areal dissolved oxygen estimate. However, this component is not readily visible by simply averaging the tidal height time series each month for the three years of data used above.
