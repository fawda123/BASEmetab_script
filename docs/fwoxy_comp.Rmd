...
The value is an instantaneous measure at 15min/m. To convert to hr/cm, we multiply by 100 / 4 (or 25).

```{r}
bts * 25
```

This is about half of what it should be, which is expected given that the gas exchange was over-estimated for EBASE.
